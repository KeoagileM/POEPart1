...
namespace POEPart1
{
    public class Interaction
    {
        ...
        public void getFacts(Dictionary<string, List<string>> topicResponses)
        {
            ...
            do
            {
                ...
                foreach (var messages in topicResponses)
                {
                    ...
                    if (response.Contains(keyword))
                    {
                        ...
                        {
                            feelingTopic = keyword;
                            message = "Its okay to be curious about " + feelingTopic + " just know that " + responses[random.Next(responses.Count)];
                        }
